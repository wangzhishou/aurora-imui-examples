...
class ThemeFragment : Fragment(), View.OnTouchListener {
    ...
    override fun onCreateView(
        ...
        mViewModel = activity?.let { ThemeActivity.obtainViewModel(it) }
        setup()
    ...
    fun setup() {
        ...
        header.setPadding(0, DisplayUtil.dp2px(requireActivity(), 15f), 0,
                DisplayUtil.dp2px(requireActivity(), 10f))
        ...
        mChatInput!!.setMenuClickListener(object : OnMenuClickListener {
            override fun switchToMicrophoneMode(): Boolean {
                ...
                if (!EasyPermissions.hasPermissions(requireActivity(), *params)) {
...
//        msgList.setReceiveBubblePaddingRight(DisplayUtil.dp2px(activity, 10f))
    ...
    private fun configLightTheme() {
        ...
        activity?.resources?.let { msgList.setSendBubbleTextColor(it.getColor(R.color.light_send_text_color)) }
        activity?.resources?.let { msgList.setReceiveBubbleTextColor(it.getColor(R.color.light_receive_text_color)) }
